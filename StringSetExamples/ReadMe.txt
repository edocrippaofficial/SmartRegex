...
Please note that this program is not generating the regex from scratch, so the starting regex should be something
like [a-z]+ in case of alphanumeric regex.
